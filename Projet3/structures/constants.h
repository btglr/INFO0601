...
#define COMMAND_TOOLS_INFORMATION COMMAND_TOOLS_POS_Y + 2
#define COMMAND_TOOLS_LEMMINGS COMMAND_TOOLS_INFORMATION + 1
#define COMMAND_TOOLS_ADD_POS_Y COMMAND_TOOLS_LEMMINGS + 2
